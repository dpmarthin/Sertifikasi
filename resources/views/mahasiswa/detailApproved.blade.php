        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('pendaftaran_approved') }}">List Approved Pendaftaran</a></li>
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3 d-flex justify-content-center">
                                <a class="btn btn-primary" href="{{ route('pendaftaran_generate_pdf', $pendaftarans->id) }}" target="_blank">Generate PDF</a>
                                <span class="mx-2"></span>
                                <a class="btn btn-secondary" href="{{ route('pendaftaran_approved') }}">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
